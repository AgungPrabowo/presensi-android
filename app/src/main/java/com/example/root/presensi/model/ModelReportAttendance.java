...
public class ModelReportAttendance {
    String id_report, employee_id, attendance_check, attendance_info, attendance_latitude, attendance_longitude, created_at, updated_at;

    public ModelReportAttendance(String id_report, String employee_id, String attendance_check, String attendance_info,
